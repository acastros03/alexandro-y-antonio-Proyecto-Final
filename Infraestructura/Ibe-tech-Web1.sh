#!/bin/bash
#==============================================================================
# Script de Aprovisionamiento: Web Server 1 (Debian Bookworm)
# Hostname: Ibe-tech-WEB1
# Red 2 (Balanceador): 192.168.2.2
# Red 3 (NFS): 192.168.3.3
#==============================================================================

set -e

echo "=========================================="
echo "Aprovisionando Web Server 1"
echo "Hostname: Ibe-tech-WEB1"
echo "=========================================="
...
<head>
    ...
    <title>Web Server 1 - Ibe-tech</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
echo "=========================================="
echo "Hostname: Ibe-tech-WEB1"
echo "IP Balanceador: 192.168.2.2"
echo "IP NFS: 192.168.3.3"
