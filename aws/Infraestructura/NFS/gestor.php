...
if ($accion === 'estado') {
    ...
    $repl = ssh_exec(
        '10.0.5.231',
        "mysql -u root -pibetech2024 -e 'SHOW SLAVE STATUS\\G' 2>/dev/null | grep -w 'Slave_IO_Running:\\|Slave_SQL_Running:'",
        $PEM
    );
    ...
    $resultado[] = [
        ...
        'estado'   => (strpos($repl['output'], 'Yes') !== false) ? 'ACTIVO' : $repl['output'],
